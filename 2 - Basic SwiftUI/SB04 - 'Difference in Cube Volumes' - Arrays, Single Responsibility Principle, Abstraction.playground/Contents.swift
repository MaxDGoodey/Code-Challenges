...
func differenceInVolumes(cube1: [Int], cube2: [Int]) -> Int {
    let cube1Volume = cube1[0] * cube1[1] * cube1[2]
    let cube2Volume = cube2[0] * cube2[1] * cube2[2]
    return abs(cube1Volume - cube2Volume)
}

print(differenceInVolumes(cube1: [1, 1, 1], cube2: [2, 2, 2]))
